# =============================================================================
# Onomatopoeia U-Net Training & Testing Experiment Script (PowerShell版)
# =============================================================================
# train_unet_split.pyを使用して、onomatopoeia_dataset内の全データセットで
# U-Netモデルを学習し、test_unet.pyでテストを実行します。
#
# 使用方法:
#   .\run_onomatopoeia_experiments.ps1
#
# オプション:
#   .\run_onomatopoeia_experiments.ps1 -SkipTraining   # 学習をスキップしてテストのみ
#   .\run_onomatopoeia_experiments.ps1 -SkipTest       # テストをスキップして学習のみ
# =============================================================================
...
Write-Host "  Onomatopoeia U-Net Training & Testing" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host ""
