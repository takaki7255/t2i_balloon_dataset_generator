"""
DeepLabv3+ training script with flexible configuration

Command Line Usage Examples:
----------------------------
# Basic training with pretrained ResNet50, output_stride=16
python train_deeplabv3plus.py --root ./balloon_dataset/real200_dataset --dataset real200

# Training from scratch (no pretrained)
python train_deeplabv3plus.py --root ./balloon_dataset/real200_dataset --dataset real200 --no-pretrained

# ResNet101 with pretrained, output_stride=8
...
python train_deeplabv3plus.py --resume ./balloon_models/real200-deeplabv3plus-resnet50-pretrained-s16-01.pt
...
def parse_args():
    ...
    parser.add_argument('--output-stride', type=int, default=None, choices=[8, 16],
                        help='Output stride (default: use CFG["OUTPUT_STRIDE"])')
...
def main():
    ...
    prefix = f"{dataset_name}-deeplabv3plus-{cfg['BACKBONE']}-{pretrained_suffix}-s{cfg['OUTPUT_STRIDE']}"
